// 7. Add 'PLAY GACHA' Button And Process to minus credit and random prize also show in Message box
"use client";
...
const GachaMachine = () => {
  ...
  function handleClickPlayGacha() {
    console.log("handleClickPlayGacha");
    if (credit < costPerRound) {
      alert("You don't have enough credit to play!");
            ...
            <Card>
              <CardHeader shadow={false} floated={false}>
                <div className="flex items-center justify-between p-4">
                  ...
                  <Button color="yellow" onClick={handleClickPlayGacha}>
                    PLAY GACHA
                  </Button>
                </div>
              </CardHeader>
